    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('edit-register', ['id'=>$user->id]) }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <label for="department" class="col-md-4 col-form-label text-md-right">{{__('Department') }}</label>
                              <div class="col-md-6">
                            <select name="department" id="department" class="form-control" value="{{ $user->department }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nic" type="text" class="form-control" name="nic" value="{{ $user->nic }}"  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="admission_no" type="text" class="form-control" name="admission_no" value="{{ $user->admission_no }}" autofocus>
