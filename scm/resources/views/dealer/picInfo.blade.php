...
<div class="page-header row no-gutters py-4" data-backdrop="false">
	<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
		<span class="text-uppercase page-subtitle">Dealer Dashboard</span>
			<h3 class="page-title">Upload the photos</h3>
...
<div class="row" >
	...
	<div class="col-lg-12 col-md-12 col-sm-12 mb-4">
		<br>
			...
			<form enctype="multipart/form-data" action="{{route('dealer_imagesStore', $post->id)}}" method="post">
			@csrf
			...
			<div class="card-body">
				  ...
				  <div id="Sedan" class="colors " @if($post->body_style=='sedan') @else hidden @endif>
				  	<div class="row" id="imageGallery">
				  		...
				  		<div class="col-lg-3 p-2">
				  			<div class="card">
				  				<img src="/images/330/11.jpg" class="img-fluid card-img-top">
				  				<h5 class="card-title text-center bg-danger text-white">11</h5>
				  			</div>
				  		</div>
				  		<div class="col-lg-3 p-2">
				  			<div class="card">
				  				<img src="/images/placeholder.jpg" class="img-fluid card-img-top" id="v11"/>
				  				<label for="upload-photo11" class="text-center bg-primary text-white">Insert Image</label>
				  				<input type="file" name="image11" value="" id="upload-photo11"  onchange="readURL11(this);" hidden>
				  			</div>
				  		</div>
				  		<div class="col-lg-3 p-2">
				  			<div class="card">
				  				<img src="/images/330/12.jpg" class="img-fluid card-img-top">
				  				<h5 class="card-title text-center bg-danger text-white">12</h5>
				  			</div>
				  		</div>
				  		<div class="col-lg-3 p-2">
				  			<div class="card">
				  				<img src="/images/placeholder.jpg" class="img-fluid card-img-top" id="v12"/>
				  				<label for="upload-photo12" class="text-center bg-primary text-white">Insert Image</label>
				  				<input type="file" name="image12" value="" id="upload-photo12"  onchange="readURL12(this);" hidden>
				  			</div>
				  		</div>
				  		<div class="col-lg-3 p-2">
				  			<div class="card">
				  				<img src="/images/330/13.jpg" class="img-fluid card-img-top">
				  				<h5 class="card-title text-center bg-danger text-white">13</h5>
				  			</div>
				  		</div>
				  		<div class="col-lg-3 p-2">
				  			<div class="card">
				  				<img src="/images/placeholder.jpg" class="img-fluid card-img-top" id="v13"/>
				  				<label for="upload-photo13" class="text-center bg-primary text-white">Insert Image</label>
				  				<input type="file" name="image13" value="" id="upload-photo13"  onchange="readURL13(this);" hidden>
				  			</div>
				  		</div>
				  		<div class="col-lg-3 p-2">
				  			<div class="card">
				  				<img src="/images/330/14.jpg" class="img-fluid card-img-top">
				  				<h5 class="card-title text-center bg-danger text-white">14</h5>
				  			</div>
				  		</div>
				  		<div class="col-lg-3 p-2">
				  			<div class="card">
				  				<img src="/images/placeholder.jpg" class="img-fluid card-img-top" id="v14"/>
				  				<label for="upload-photo14" class="text-center bg-primary text-white">Insert Image</label>
				  				<input type="file" name="image14" value="" id="upload-photo14"  onchange="readURL14(this);" hidden>
				  			</div>
				  		</div>
				  		<div class="col-lg-3 p-2">
				  			<div class="card">
				  				<img src="/images/330/15.jpg" class="img-fluid card-img-top">
				  				<h5 class="card-title text-center bg-danger text-white">15</h5>
				  			</div>
				  		</div>
				  		<div class="col-lg-3 p-2">
				  			<div class="card">
				  				<img src="/images/placeholder.jpg" class="img-fluid card-img-top" id="v15"/>
				  				<label for="upload-photo15" class="text-center bg-primary text-white">Insert Image</label>
				  				<input type="file" name="image15" value="" id="upload-photo15"  onchange="readURL15(this);" hidden>
				  			</div>
				  		</div>
				  	</div>
				  </div>
